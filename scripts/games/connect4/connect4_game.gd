...
func _style_slot(slot: Button, color: Color) -> void:
	...
	sb.bg_color = color
	sb.corner_radius_top_left = CELL_SIZE / 2
	sb.corner_radius_top_right = CELL_SIZE / 2
	sb.corner_radius_bottom_left = CELL_SIZE / 2
	sb.corner_radius_bottom_right = CELL_SIZE / 2
